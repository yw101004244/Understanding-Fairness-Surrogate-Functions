...
def load_compas_data():
	...
	COMPAS_INPUT_FILE = r"C:\Users\yao\Desktop\understanding\fairness\COMPAS\compas-scores-two-years.csv"

	# load the data and get some stats
	df = pd.read_csv(COMPAS_INPUT_FILE,header=0,sep=',')
