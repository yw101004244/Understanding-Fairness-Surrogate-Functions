...
def test_compas_data():
	...
	ut.compute_violation_of_disparate_impact(x_control['race'], y) # compute the p-rule in the original data
	...
	for i in range(0,100,10):
		...
		sep_constraint = 0
		gamma = i/10 # gamma controls how much loss in accuracy we are willing to incur to achieve fairness -- increase gamme to allow more loss in accuracy
		print(i)
